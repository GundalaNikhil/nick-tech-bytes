...
const allTutorials = {
  beginner: [
    ...
    },
    {
      ...
      shortAnswer:
        "A view is a virtual table based on a SQL query result set. It provides a way to simplify complex queries and enhance security.",
    },
    {
      id: 13,
      ...
      shortAnswer:
        "A stored procedure is a prepared SQL code that you can save and reuse. It improves performance and reduces code duplication.",
    },
    {
      id: 14,
    ...
    },
    {
      ...
      shortAnswer:
        "A self-join is joining a table to itself to compare rows within the same table, commonly used for hierarchical data.",
    },
    {
      id: 18,
      ...
      shortAnswer:
        "Normalization is organizing data to reduce redundancy. It involves dividing tables and establishing relationships through normal forms.",
    },
    {
      id: 19,
      ...
      shortAnswer:
        "Denormalization is intentionally introducing redundancy to improve query performance by reducing joins.",
    },
    {
      id: 20,
      ...
      shortAnswer:
        "An index is a data structure that improves query speed. Types include Primary, Unique, Full-text, Composite, and Spatial indexes.",
    },
    {
      id: 21,
      ...
      shortAnswer:
        "Clustered index determines physical order of data (one per table). Non-clustered index is separate with pointers to data (multiple allowed).",
    },
    {
      id: 22,
      ...
      shortAnswer:
        "A composite index is an index on two or more columns, useful for queries filtering on multiple columns.",
    },
    {
      id: 23,
      ...
      shortAnswer:
        "A covering index contains all columns needed by a query, eliminating the need to access the actual table data.",
    },
    {
      id: 24,
      ...
      shortAnswer:
        "Avoid indexes on small tables, columns with frequent updates, low cardinality columns, or when write performance is critical.",
    },
    {
      id: 25,
      ...
      shortAnswer:
        "EXPLAIN shows how MySQL executes a query, helping identify performance issues and optimize query execution plans.",
    },
  ],
  intermediate: [
    {
      ...
      shortAnswer:
        "Use GROUP BY with HAVING COUNT(*) > 1 to identify duplicate records based on specific columns.",
      codeTemplate: true,
    },
    {
      id: 2,
      ...
      shortAnswer:
        "Use ROW_NUMBER() window function or self-join with DELETE to remove duplicates while keeping one record.",
      codeTemplate: true,
    },
    {
      id: 3,
      ...
      question:
        "Write a query to get the 2nd highest salary from Employee table",
      shortAnswer:
        "Use LIMIT with OFFSET, or use subquery with MAX to find second highest value.",
      codeTemplate: true,
    },
    {
      id: 4,
      ...
      shortAnswer:
        "Use DENSE_RANK() or LIMIT with OFFSET (n-1) to find the nth highest value.",
      codeTemplate: true,
    },
    {
      id: 5,
      ...
      shortAnswer:
        "UNION removes duplicates and is slower. UNION ALL keeps all rows including duplicates and is faster.",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      shortAnswer:
        "Use self-join to compare employee salary with manager salary from the same table.",
      codeTemplate: true,
    },
    {
      id: 8,
      ...
      shortAnswer:
        "Window functions perform calculations across rows related to current row without grouping. Examples: ROW_NUMBER, RANK, LAG, LEAD.",
    },
    {
      id: 9,
      ...
      shortAnswer:
        "Use CASE statements with aggregation or dynamic SQL to transform row values into column headers.",
      codeTemplate: true,
    },
    {
      id: 10,
      ...
      shortAnswer:
        "CTE is a temporary named result set defined using WITH clause, improving query readability and enabling recursion.",
    },
    {
      id: 11,
      title: "Recursive CTE",
      ...
      shortAnswer:
        "Recursive CTE has anchor and recursive member to traverse hierarchical data like org charts or category trees.",
      codeTemplate: true,
    },
    {
      id: 12,
      ...
      shortAnswer:
        "Aggregate functions ignore NULLs except COUNT(*). Use COALESCE or IFNULL to handle NULLs explicitly.",
    },
    {
      id: 13,
      ...
      shortAnswer:
        "COALESCE returns first non-NULL value. NULLIF returns NULL if two expressions are equal, otherwise first expression.",
    },
    {
      id: 14,
      ...
      shortAnswer:
        "Use FULLTEXT index type for text searching with MATCH() AGAINST() for efficient text search in large columns.",
      codeTemplate: true,
    },
    {
      id: 15,
      ...
      shortAnswer:
        "DATETIME stores absolute date-time (1000-9999). TIMESTAMP stores Unix timestamp with timezone conversion and auto-update.",
    },
    {
      id: 16,
      ...
      shortAnswer:
        "Use JSON data type with JSON functions like JSON_EXTRACT, JSON_SET, and -> operator for querying nested data.",
      codeTemplate: true,
    },
    {
      id: 17,
      ...
      shortAnswer:
        "Generated (computed) columns automatically calculate values from other columns, can be VIRTUAL or STORED.",
    },
    {
      id: 18,
      ...
      shortAnswer:
        "Use AES_ENCRYPT/AES_DECRYPT functions or application-level encryption for sensitive data protection.",
    },
    {
      id: 19,
      ...
      shortAnswer:
        "Use EXPLAIN, add indexes, avoid SELECT *, optimize joins, use query cache (deprecated in 8.0), and proper indexing.",
    },
    {
      id: 20,
      ...
      shortAnswer:
        "Slow query log records queries exceeding long_query_time threshold for performance analysis and optimization.",
    },
  ],
  advanced: [
    {
      ...
      shortAnswer:
        "Buffer pool is InnoDB's in-memory cache for data and indexes, using LRU algorithm for performance optimization.",
    },
    {
      id: 2,
      ...
      shortAnswer:
        "Redo log ensures durability by recording changes for crash recovery. Undo log supports rollback and MVCC.",
    },
    {
      id: 3,
      ...
      shortAnswer:
        "Uses redo logs to replay committed transactions and undo logs to rollback uncommitted transactions after crash.",
    },
    {
      id: 4,
      ...
      shortAnswer:
        "Safety mechanism that writes pages to doublewrite buffer before writing to data files, preventing partial page writes.",
    },
    {
      id: 5,
      ...
      shortAnswer:
        "Binlog is server-level logical log for replication. Redo log is InnoDB-level physical log for crash recovery.",
    },
    {
      id: 6,
      ...
      shortAnswer:
        "Master writes to binlog, slaves read and apply changes. GTID provides global unique transaction IDs for easier failover.",
    },
    {
      id: 7,
      ...
      shortAnswer:
        "Plugin for multi-master replication with automatic failover, conflict detection, and distributed recovery.",
    },
    {
      id: 8,
      title: "MySQL Router",
      ...
      shortAnswer:
        "Lightweight middleware for routing database traffic, providing high availability and load balancing.",
    },
    {
      id: 9,
      ...
      shortAnswer:
        "Use MySQL Router or ProxySQL to route writes to master and reads to replicas for scaling read traffic.",
    },
    {
      id: 10,
      ...
      shortAnswer:
        "Horizontal partitioning distributing data across multiple databases. Implement via application logic or tools like Vitess.",
    },
  ],
};
...
const generateFullTutorial = (config) => {
  ...
  const levelColors = {
    ...
    advanced: {
      primary: "#EF4444",
      secondary: "#F87171",
      gradient: "rgba(239, 68, 68, 0.15), rgba(248, 113, 113, 0.15)",
    },
  };
...
<div style="background: linear-gradient(135deg, ${
    ...
    colors.primary
  }50; padding: 24px; border-radius: 12px; margin: 20px 0;">
...
Object.entries(allTutorials).forEach(([level, tutorials]) => {
  tutorials.forEach((tutorial) => {
    const filename = `${level}-${String(tutorial.id).padStart(
      2,
      "0"
    )}-${tutorial.title
      .toLowerCase()
