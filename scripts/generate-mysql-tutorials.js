...
VALUES (99, '2024-01-15', 200.00);`,
    ...
    nextSteps: [
      {
        title: "Primary Key",
        link: "/mysql-tutorials/beginner-07-primary-key",
      },
      { title: "Joins in MySQL", link: "/mysql-tutorials/beginner-16-joins" },
      {
        title: "Normalization",
        link: "/mysql-tutorials/beginner-18-normalization",
      },
    ],
  },
  {
    ...
    nextSteps: [
      {
        ...
        link: "/mysql-tutorials/beginner-11-drop-vs-truncate",
      },
      {
        title: "Transactions in MySQL",
        link: "/mysql-tutorials/intermediate-acid",
      },
