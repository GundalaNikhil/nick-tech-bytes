  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-2">
              {topic.companies.map((company) => (
                <span
                  key={company}
                  className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium border border-emerald-500/30"
                >
                  {company}
                </span>
              ))}
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        <article className="prose prose-invert prose-emerald max-w-none prose-headings:scroll-mt-20 prose-h1:text-3xl prose-h1:text-emerald-400 prose-h2:text-2xl prose-h2:text-white prose-h2:border-b prose-h2:border-gray-800 prose-h2:pb-2 prose-h2:mt-12 prose-h3:text-xl prose-h3:text-gray-200 prose-p:text-gray-300 prose-strong:text-white prose-code:text-emerald-400 prose-code:bg-gray-800/50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-pre:bg-gray-950 prose-pre:border prose-pre:border-gray-800 prose-pre:rounded-xl prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:text-emerald-300 prose-li:text-gray-300 prose-table:border-gray-800 prose-th:border-gray-700 prose-td:border-gray-700 prose-th:bg-gray-800/50 prose-blockquote:border-emerald-500/50 prose-blockquote:text-gray-400">
          <ReactMarkdown
            components={{
              code({ node, inline, className, children, ...props }) {
                ...
                return !inline && match ? (
                  ...
                  <code className="bg-gray-800/50 px-1.5 py-0.5 rounded text-sm font-mono text-emerald-400" {...props}>
                    {children}
                  </code>
                );
              },
