  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="border-t border-gray-300 pt-6">
            ...
            <div className="flex flex-wrap gap-2">
              {topic.companies.map((company) => (
                <span
                  key={company}
                  className="inline-flex items-center px-4 py-2 rounded-lg bg-blue-50 text-blue-700 text-sm font-medium border border-blue-200 hover:border-blue-400 hover:bg-blue-100 transition-all"
                >
                  {company}
                </span>
              ))}
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        {/* Quick Tips Section */}
        <div className="mt-12 p-6 md:p-8 rounded-2xl bg-blue-50 border border-blue-200">
          <div className="flex items-center gap-3 mb-4">
          ...
          <ul className="space-y-3 text-gray-800">
            ...
            <li className="flex items-start gap-3">
              <span className="text-blue-600 mt-1 font-bold">•</span>
              <span>Draw diagrams to visualize your design</span>
            </li>
          </ul>
        </div>
      </div>
