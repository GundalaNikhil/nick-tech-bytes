      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black">
        ...
        <div className="relative border-b border-gray-800/50 bg-gradient-to-r from-gray-900/95 via-gray-950/95 to-gray-900/95 backdrop-blur-xl">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            {/* Title Section */}
            <div className="mb-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-4 backdrop-blur-sm">
            ...
            <div className="border-t border-gray-800/50 pt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {topic.companies.map((company) => (
                  <span
                    key={company}
                    className="inline-flex items-center px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500/10 to-purple-500/10 text-gray-200 text-sm font-medium border border-cyan-500/20 hover:border-cyan-500/40 hover:bg-cyan-500/20 transition-all duration-300 hover:scale-105 cursor-default shadow-lg shadow-black/10"
                  >
                    {company}
                  </span>
                ))}
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 p-6 md:p-8 rounded-2xl bg-gradient-to-br from-gray-900/80 to-gray-800/80 border border-gray-700/50 backdrop-blur-sm shadow-2xl">
            ...
            <div className="mb-4 p-4 bg-purple-500/10 border-l-4 border-purple-500/50 rounded-r-lg backdrop-blur-sm">
              ...
              <p className="text-sm text-gray-100 leading-relaxed">
                ...
                programming skills and ability to create clean, maintainable
                code following SOLID principles and design patterns.
              </p>
            </div>
            <article
          ...
          <div className="mt-12 p-6 md:p-8 rounded-2xl bg-gradient-to-br from-cyan-900/20 to-purple-900/20 border border-cyan-500/30 backdrop-blur-sm shadow-2xl">
            <div className="flex items-center gap-3 mb-4">
            ...
            <ul className="space-y-3 text-gray-100">
              <li className="flex items-start gap-3">
                <span className="text-cyan-400 mt-1 font-bold text-lg">•</span>
