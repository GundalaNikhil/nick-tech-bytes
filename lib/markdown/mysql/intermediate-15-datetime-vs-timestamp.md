...
**Aim:** DATETIME stores absolute date-time (1000-9999). TIMESTAMP stores Unix timestamp with timezone conversion and auto-update.
...
1. **Main Concept:** DATETIME stores absolute date-time (1000-9999). TIMESTAMP stores Unix timestamp with timezone conversion and auto-update.
