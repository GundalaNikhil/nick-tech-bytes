...
**Aim:** Binlog is server-level logical log for replication. Redo log is InnoDB-level physical log for crash recovery.
...
1. **Main Concept:** Binlog is server-level logical log for replication. Redo log is InnoDB-level physical log for crash recovery.
