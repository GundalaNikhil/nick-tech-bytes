...
**Aim:** Avoid indexes on small tables, columns with frequent updates, low cardinality columns, or when write performance is critical.
...
1. **Main Concept:** Avoid indexes on small tables, columns with frequent updates, low cardinality columns, or when write performance is critical.
