...
**Aim:** Use DENSE_RANK() or LIMIT with OFFSET (n-1) to find the nth highest value.
...
1. **Main Concept:** Use DENSE_RANK() or LIMIT with OFFSET (n-1) to find the nth highest value.
