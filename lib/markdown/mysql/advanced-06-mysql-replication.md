...
**Aim:** Master writes to binlog, slaves read and apply changes. GTID provides global unique transaction IDs for easier failover.
...
1. **Main Concept:** Master writes to binlog, slaves read and apply changes. GTID provides global unique transaction IDs for easier failover.
