...
**Aim:** An index is a data structure that improves query speed. Types include Primary, Unique, Full-text, Composite, and Spatial indexes.
...
1. **Main Concept:** An index is a data structure that improves query speed. Types include Primary, Unique, Full-text, Composite, and Spatial indexes.
