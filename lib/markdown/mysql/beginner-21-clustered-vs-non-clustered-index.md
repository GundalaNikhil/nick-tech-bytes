...
**Aim:** Clustered index determines physical order of data (one per table). Non-clustered index is separate with pointers to data (multiple allowed).
...
<div style="background: rgba(31, 41, 55, 0.5); padding: 20px; border-radius: 10px; margin: 10px 0;">
  <h4 style="color: #60A5FA; margin-top: 0;">Key Concept</h4>
...
1. **Main Concept:** Clustered index determines physical order of data (one per table). Non-clustered index is separate with pointers to data (multiple allowed).
