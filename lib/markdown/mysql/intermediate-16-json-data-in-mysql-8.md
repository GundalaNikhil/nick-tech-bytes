# JSON Data in MySQL 8+

## 🎯 Question & Objective

**Question:** How to store and query JSON data in MySQL 8+?

**Aim:** Use JSON data type with JSON functions like JSON_EXTRACT, JSON_SET, and -> operator for querying nested data.
...
1. **Main Concept:** Use JSON data type with JSON functions like JSON_EXTRACT, JSON_SET, and -> operator for querying nested data.
