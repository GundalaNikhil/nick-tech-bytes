...
**Aim:** Use self-join to compare employee salary with manager salary from the same table.
...
1. **Main Concept:** Use self-join to compare employee salary with manager salary from the same table.
