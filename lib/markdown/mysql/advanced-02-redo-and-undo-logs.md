...
**Aim:** Redo log ensures durability by recording changes for crash recovery. Undo log supports rollback and MVCC.
...
1. **Main Concept:** Redo log ensures durability by recording changes for crash recovery. Undo log supports rollback and MVCC.
