...
**Aim:** Window functions perform calculations across rows related to current row without grouping. Examples: ROW_NUMBER, RANK, LAG, LEAD.
...
1. **Main Concept:** Window functions perform calculations across rows related to current row without grouping. Examples: ROW_NUMBER, RANK, LAG, LEAD.
