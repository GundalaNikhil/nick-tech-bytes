...
**Aim:** Uses redo logs to replay committed transactions and undo logs to rollback uncommitted transactions after crash.
...
1. **Main Concept:** Uses redo logs to replay committed transactions and undo logs to rollback uncommitted transactions after crash.
