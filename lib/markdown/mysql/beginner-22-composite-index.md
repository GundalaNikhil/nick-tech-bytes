...
**Aim:** A composite index is an index on two or more columns, useful for queries filtering on multiple columns.
...
1. **Main Concept:** A composite index is an index on two or more columns, useful for queries filtering on multiple columns.
