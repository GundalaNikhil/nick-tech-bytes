...
**Aim:** Aggregate functions ignore NULLs except COUNT(*). Use COALESCE or IFNULL to handle NULLs explicitly.
...
1. **Main Concept:** Aggregate functions ignore NULLs except COUNT(*). Use COALESCE or IFNULL to handle NULLs explicitly.
