...
**Aim:** Buffer pool is InnoDB's in-memory cache for data and indexes, using LRU algorithm for performance optimization.
...
1. **Main Concept:** Buffer pool is InnoDB's in-memory cache for data and indexes, using LRU algorithm for performance optimization.
