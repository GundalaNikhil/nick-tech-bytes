...
**Aim:** A covering index contains all columns needed by a query, eliminating the need to access the actual table data.
...
1. **Main Concept:** A covering index contains all columns needed by a query, eliminating the need to access the actual table data.
