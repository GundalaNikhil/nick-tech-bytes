...
export const mysqlTutorialsCatalog: MySQLTutorial[] = [
  ...
  // ========================================
  {
    ...
    readTime: "8 min",
    description:
      "Understand what MySQL is, its core purpose, and the reasons behind its widespread adoption in the software industry.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Learn the fundamental difference between SQL (the language) and MySQL (the database system).",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Explore MySQL tablespace types including System, File-per-Table, General, Undo, and Temporary tablespaces.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Compare MyISAM and InnoDB storage engines and understand when to use each.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Learn about Atomicity, Consistency, Isolation, and Durability in database transactions.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Understand primary keys, their rules, types (simple, composite, auto-increment), and best practices.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Learn about foreign keys, referential integrity, cascade actions, and table relationships.",
  ...
  },
  {
    ...
    readTime: "8 min",
    description:
      "Compare CHAR and VARCHAR data types, their storage mechanisms, and when to use each.",
  ...
  },
  {
    ...
    readTime: "8 min",
    description:
      "Understand the difference between DELETE and TRUNCATE commands, their performance and use cases.",
  ...
  },
  {
    ...
    readTime: "7 min",
    description:
      "Learn the difference between DROP and TRUNCATE statements in MySQL.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Understand what views are, how to create them, and their benefits for security and simplification.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Learn how to create and use stored procedures for code reusability and performance.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Understand triggers, their types (BEFORE/AFTER, INSERT/UPDATE/DELETE), and use cases.",
  ...
  },
  {
    ...
    readTime: "15 min",
    description:
      "Master INNER JOIN, LEFT JOIN, RIGHT JOIN, and FULL OUTER JOIN with examples.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Learn how to join a table to itself for hierarchical data and comparisons.",
  ...
  },
  {
    ...
    readTime: "15 min",
    description:
      "Understand database normalization and its normal forms to reduce redundancy.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Learn when and why to denormalize databases for performance optimization.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Understand what indexes are and the different types: Primary, Unique, Full-text, Composite.",
  ...
  },
  {
    ...
    readTime: "9 min",
    description:
      "Learn what covering indexes are and how they improve query performance.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Learn how to use EXPLAIN to analyze and optimize SQL queries.",
  ...
  // ========================================
  {
    ...
    readTime: "10 min",
    description:
      "Learn multiple approaches to identify duplicate rows using GROUP BY, self-joins, and window functions.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Master techniques to delete duplicate rows while keeping one using ROW_NUMBER and CTEs.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Find the second highest value using LIMIT, MAX, DENSE_RANK, and subqueries.",
  ...
  },
  {
    ...
    readTime: "8 min",
    description:
      "Understand the difference between UNION and UNION ALL and their performance implications.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Compare the three ranking window functions and learn when to use each.",
  ...
  },
  {
    ...
    readTime: "15 min",
    description:
      "Comprehensive guide to window functions: LAG, LEAD, FIRST_VALUE, LAST_VALUE, and more.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Learn how to pivot data using CASE statements and conditional aggregation.",
  ...
  },
  {
    ...
    readTime: "15 min",
    description:
      "Use recursive CTEs for hierarchical data and tree structures.",
  ...
  },
  {
    ...
    readTime: "12 min",
    description:
      "Implement full-text search using FULLTEXT indexes and MATCH AGAINST.",
  ...
  },
  {
    ...
    readTime: "8 min",
    description:
      "Understand differences between DATETIME and TIMESTAMP data types.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Use VIRTUAL and STORED generated columns for computed values.",
  ...
  },
  {
    ...
    readTime: "10 min",
    description:
      "Configure and analyze slow query log for performance monitoring.",
  ...
  },
  {
    ...
    readTime: "15 min",
    description:
      "Understand redo logs for crash recovery and undo logs for MVCC.",
  ...
  },
  {
    ...
    readTime: "20 min",
    description:
      "Master MySQL replication: asynchronous, semi-synchronous, and GTID-based.",
  ...
  },
  {
    ...
    readTime: "18 min",
    description:
      "Implement multi-master replication with MySQL Group Replication.",
...
// Helper functions
export const getTutorialsByLevel = (
  level: "beginner" | "intermediate" | "advanced"
) => {
...
export const getTutorialStats = () => {
  ...
  const completed = mysqlTutorialsCatalog.filter(
    (t) => t.hasFullContent
  ).length;
  const byLevel = {
